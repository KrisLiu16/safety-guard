...
WINDOW_CHECKPOINT_SHA256 = "bb16a3a6f87748ce302d6db125822b31add9a7d5210cd44804d9416be44f30d2"
CORE_VERSIONS = {
...
def validate_selection(document):
    ...
    if (document.get("inference_engine") != INFERENCE_ENGINE
            or document.get("candidate") != "window" or document.get("variant") != "window"
            or document.get("checkpoint_sha256") != WINDOW_CHECKPOINT_SHA256):
        raise ValueError("The fast bundle requires the fixed W512 SFT weights and window_cuda_graph engine")
...
def verify_bundle(bundle):
    ...
    required = {"MODEL_MANIFEST.json", "classifier.safetensors", "assets/config.json",
                ...
                "graph_text_runtime.py", "window_attention.py", "requirements.txt"}
