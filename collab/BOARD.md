...
| [T033](assignments/T033-distill-4b-v3.md) | 第二阶段 v3：每个角色加一个通用头，用 Qwen3Guard-Stream-4B 逐 token 蒸馏（KL 0.5 + 类别 CE 0.25），红线头照 v2 训练 | 执行方（兼设计） | 训完（选第 1 轮，红线 calibration AUC 0.922，通用头对老师 AUC 0.984）；评测中（第一张卡） | T030 数据 ✓ |
