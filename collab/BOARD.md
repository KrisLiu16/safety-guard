...
| [T026](assignments/T026-political-special.md) | 政治专项：luna 对全部 340,883 个词做政治预筛，再复查、做领导人词复查和最终核对；按专项规则在 Mac 上重出六份标签（代码见 round6/political_screen_v1/） | 执行方 | v1.2 停在第 9 步：Run A 15%、领导人词 25% 误命中，都是三遍结论一致的冷僻词、泛指词 → v1.3 加本地排除表（人工核对把普通文本提档的词），两字带 ambiguous 的词不匹配，领导人负面要两遍一致，跨组的词只在政治文本里生效；接受 `general_scope` 带来的 usable 减少（0.52%） | T012 ✓、T021 ✓、T024 ✓ |
