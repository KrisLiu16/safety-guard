"""Build the 50-word v13 pilot from complete v12 words, one Task per source group.
...
round4/round5 datasets so later dev/calibration splits stay clean.
"""
...
def main():
    ...
    for ordinal, (group, seeds) in enumerate(chosen.items()):
        key = f"pilot-response-v13-{ordinal:02d}"
        task = tasks / key
